...
{
    public class ClientesController : Teste<Cliente>
    {
        ...
        {
            var clientes = db.Clientes.Include(c => c.Cidade).Where(c => c.Nome.Contains(nome)).ToList();
            return PartialView("Lista", clientes);
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            Cliente cliente = db.Clientes.Include(c => c.Observacao).Where(c => c.Codigo == id).FirstOrDefault();
